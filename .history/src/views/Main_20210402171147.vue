...
export default {
  ...
  methods: {
    ...
    setActiveAnchorCirclePosition() {
      this.$nextTick(() => {
        const currentAnchorEl = this.$refs.header.querySelector('.active')
        if(currentAnchorEl){
          this.activeAnchorTop = getRelativePosition(currentAnchorEl, this.$refs.header).y + currentAnchorEl.clientHeight/2 
